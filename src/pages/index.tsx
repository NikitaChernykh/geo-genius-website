      ...
      <section className={styles.columnSection}>
        <div className={styles.column}>
          ...
          <p className={styles.columnText}>
            ...
            Each continent serves as a distinct learning section, allowing you
        ...
        <div className={styles.column}>
          ...
          <p className={styles.columnText}>
            Discover a fun and interactive way to learn the capitals of
            countries from around the world, where you can test your knowledge
            of global city names.
          </p>
        </div>
        ...
        <div className={styles.column}>
          ...
          <p className={styles.columnText}>
            ...
            identifying capitals and more through exciting challenges and
            quizzes.
          </p>
        </div>
      </section>
