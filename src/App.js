      ...
      <footer className="footer">
        ...
        <div className="copyright">
          &copy; 2023 Chernika Digital - FZCO. All Rights Reserved.
            <a href="https://www.chernikadigital.com/privacy-policy" target='_blank' className='legal-link'>Privacy Policy</a>
            <a href="https://www.chernikadigital.com/terms-of-service" target='_blank' className='legal-link'>Terms of Use</a>
        </div>
      </footer>
    </div>
  );
